      ...
      <div className="card">
        ...
        {loading ? (
          <div className="text-center py-8">
            <Loader className="w-8 h-8 text-primary-600 dark:text-primary-400 animate-spin mx-auto" />
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  placeholder="Şifre girin (değiştirmek istemiyorsanız boş bırakın)"
                  className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                />
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
              ...
              />
              <label htmlFor="use_tls" className="flex items-center gap-2 text-sm font-medium text-gray-700 dark:text-gray-300 cursor-pointer">
                <Shield className="w-4 h-4" />
                TLS/SSL Kullan (Güvenli Bağlantı)
              </label>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                <span className="text-sm text-gray-600 dark:text-gray-400">Kullanıcı Adı:</span>
                <span className="font-medium text-gray-900 dark:text-white">
                  {connectionStatus.username || 'Ayarlanmamış'}
                </span>
              </div>
              <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                <span className="text-sm text-gray-600 dark:text-gray-400">Şifre:</span>
              ...
              <div className={`p-6 rounded-lg ${
                ...
                {connectionStatus.configured ? (
                  <div className="text-center">
                    <Settings className="w-12 h-12 text-green-600 dark:text-green-400 mx-auto mb-2" />
                  ...
                  <div className="text-center">
                    <Settings className="w-12 h-12 text-yellow-600 dark:text-yellow-400 mx-auto mb-2" />
      ...
      <div className="card">
        ...
        <div className="mb-6">
          <button
            ...
            className="w-full md:w-auto px-6 py-3 bg-primary-600 hover:bg-primary-700 disabled:bg-gray-400 disabled:cursor-not-allowed text-white font-medium rounded-lg transition-colors flex items-center justify-center gap-2"
          >
            {testing ? (
              <>
        ...
        {!testResult && !testing && (
          <div className="text-center py-8 text-gray-500 dark:text-gray-400">
            ...
            <p>Bağlantıyı test etmek için yukarıdaki butona tıklayın</p>
          </div>
        )}
      </div>
    </div>
